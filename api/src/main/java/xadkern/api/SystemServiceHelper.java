...
public class SystemServiceHelper {
     ...
     * @deprecated Use {@link XadkernBinderWrapper} instead
     */
    @Deprecated
    ...
    /**
     * Obtain a new data parcel for {@link Xadkern#transactRemote(Parcel, Parcel, int)} (Parcel, Parcel, int)}.
     *
    ...
    /**
     * Obtain a new data parcel for {@link Xadkern#transactRemote(Parcel, Parcel, int)}.
     *
     * @param serviceName   system service name
    ...
    public static Parcel obtainParcel(@NonNull String serviceName, @NonNull String interfaceName, @NonNull String className, @NonNull String methodName) {
        throw new UnsupportedOperationException("Direct use of Xadkern#transactRemote is no longer supported, please use XadkernBinderWrapper");
    }
}
